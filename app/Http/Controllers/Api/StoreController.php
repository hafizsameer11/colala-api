...
class StoreController extends Controller
{
    ...
    public function getById(Request $req, $storeId) {
        try{
            $store=Store::with('user','socialLinks','businessDetails','addresses','deliveryPricing','categories','products.orderItems','products.images','products.variations','services')->findOrFail($storeId);
