...
class SellerKnowledgeBaseController extends Controller
{
    /**
     * Get knowledge base items for sellers
     * Includes both 'seller' and 'general' types
     */
    public function index(Request $request)
    {
        try {
            $query = KnowledgeBase::active()
                ->whereIn('type', ['seller', 'general'])
            ...
            // Filter by type (seller or general)
            if ($request->has('type') && in_array($request->type, ['seller', 'general'])) {
